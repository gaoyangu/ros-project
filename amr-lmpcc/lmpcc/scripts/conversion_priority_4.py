...
def callback(path_01, path_02, path_03, path_04):
    # rospy.loginfo("new Message")
    path_list = [path_01, path_02, path_03, path_04]
...
# Initialize node
rospy.init_node("conversion_multi_3")
...
ts = message_filters.TimeSynchronizer([sub_01, sub_02, sub_03, sub_04], 10)
